...
public class AppmarketMigrationController {
	 ...
	 * otherwise.
	 */
	@RequestMapping(method = POST, value = {"/api/v1/migration/validateCustomerAccount", "/api/v2/migration/validateCustomerAccount", "/api/v2/basic/migration/validateCustomerAccount"}, produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
	 ...
	 * otherwise.
	 */
	@RequestMapping(method = POST, value = {"/api/v1/migration/validateSubscription", "/api/v2/migration/validateSubscription", "/api/v2/basic/migration/validateSubscription"}, produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
	 ...
	 */
	@RequestMapping(method = POST, value = {"/api/v1/migration/subscription", "/api/v2/migration/subscription", "/api/v2/basic/migration/subscription"}, produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
