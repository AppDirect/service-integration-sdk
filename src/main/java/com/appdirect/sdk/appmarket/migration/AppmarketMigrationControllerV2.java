...
public class AppmarketMigrationControllerV2 {
	 ...
	 * @return an {@link com.appdirect.sdk.appmarket.events.APIResult#success(String)} in case the validation is successful and a {@link com.appdirect.sdk.appmarket.events.APIResult#failure(com.appdirect.sdk.appmarket.events.ErrorCode, String)}
	 * otherwise.
	 */
	...
	/**
	 * Migrate a subscription which is already validated by {@link com.appdirect.sdk.appmarket.migration.AppmarketMigrationControllerV2#validateISVSubscription(java.util.Map)}
	 *
	 * @param subscription the subscription record to be migrated
	 * @return an {@link com.appdirect.sdk.appmarket.events.APIResult#success(String)} in case the migration is successful and a {@link com.appdirect.sdk.appmarket.events.APIResult#failure(com.appdirect.sdk.appmarket.events.ErrorCode, String)}
	 */
