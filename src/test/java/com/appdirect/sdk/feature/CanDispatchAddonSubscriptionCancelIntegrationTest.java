...
public class CanDispatchAddonSubscriptionCancelIntegrationTest {
	...
	public void addonSubscriptionOrderIsProcessedSuccessfully() throws Exception {
		...
		assertThat(EntityUtils.toString(response.getEntity())).isEqualTo("{\"success\":true,\"message\":\"Event with eventToken=subscription-cancel-addon has been accepted by the connector. It will be processed soon.\"}");
