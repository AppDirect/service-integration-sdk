...
public class CanDispatchUserAssignIntegrationTest {
	...
	public void userAssignIsProcessedSuccessfully() throws Exception {
		...
		assertThat(EntityUtils.toString(response.getEntity())).isEqualTo("{\"success\":true,\"message\":\"Event with eventToken=user-assign has been accepted by the connector. It will be processed soon.\"}");
