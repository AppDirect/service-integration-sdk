...
public class UserSyncRestTemplateFactoryImplTest {
	private UserSyncRestTemplateFactoryImpl userSyncRestTemplateFactory;

	@Before
	public void setUp() {
		userSyncRestTemplateFactory = new UserSyncRestTemplateFactoryImpl();
	}
