...
public class DefaultRestTemplateFactoryTest {
	private DefaultOAuthRestTemplateFactoryImpl defaultOAuthRestTemplateFactoryImpl;

	@Before
	public void setUp() {
		defaultOAuthRestTemplateFactoryImpl = new DefaultOAuthRestTemplateFactoryImpl();
	}

	@Test
	public void testGetRestTemplate_ReturnsOauthSignedRequestFactory() throws Exception {
		RestTemplate restTemplate = defaultOAuthRestTemplateFactoryImpl.getRestTemplate("some-key", "some-secret");
